...
@Table(name = "STDOPSOPERATION_")
public class Stdopsoperation {
    @Id
    @Column(name = "ID")
    ...
    @Column(name = "OPSLEVEL_")
    private String opslevel;

    @Column(name = "DOCUMENTZ_")
    private String documentz;

    @Column(name = "LINKZ_")
    private String linkz;

    @Column(name = "STDOPSOPERATIONMARK_")
    private String stdopsoperationmark;

    @Column(name = "LINEAGE_")
    private String lineage;

    @Column(name = "STDINCISIONLEVEL_")
    private String stdincisionlevel;

    @Column(name = "STOPEDFLAG_")
    private Long stopedflag;

    @Column(name = "CNAMEINDEX_")
    private String cnameindex;

    @Column(name = "STDCONSULTATIONSUBJECT_")
    ...
    /**
     * @return STDINCISIONLEVEL_
     */
    public String getStdincisionlevel() {
        return stdincisionlevel;
    }

    /**
     * @param stdincisionlevel
     */
    public void setStdincisionlevel(String stdincisionlevel) {
        this.stdincisionlevel = stdincisionlevel;
    }
    ...
    /**
     * @return STDCONSULTATIONSUBJECT_
     */
    public String getStdconsultationsubject() {
        return stdconsultationsubject;
    }

    /**
     * @param stdconsultationsubject
     */
